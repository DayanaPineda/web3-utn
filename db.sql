...
CREATE DATABASE IF NOT EXISTS `ecorent` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ecorent`;
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `password` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL DEFAULT 'Password1234',
